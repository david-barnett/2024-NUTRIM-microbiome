...
> If you are interested in e.g. RDA, check the [Guide to Statistical Analysis in Microbial Ecology](https://sites.google.com/site/mb3gustame/constrained-analyses/redundancy-analysis){target="_blank"}
:::
...
ps %>%
  ...
  comp_heatmap(
    samples = 1:20, taxa = 1:20, 
    name = "Proportions", tax_seriation = "Identity"
  )
```
