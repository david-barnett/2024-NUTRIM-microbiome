...
1.  Alpha diversity - simple stats
2.  Overall compositions
    1.  Interactive ordination plots and bar charts
    2.  PCoA and PERMANOVA
    3.  Bar charts
...
You can use standard statistical testing on the richness or diversity values e.g. linear regression
...
You can get a tidy tibble of results with the `tidy()` function from `broom` package.
