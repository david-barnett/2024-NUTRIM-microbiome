...
Several patients recently took corticosteroids or other immunosuppressive medications - 
...
<https://david-barnett.github.io/microViz/articles/web-only/heatmaps.html#correlation-heatmaps>{target="_blank"}

Tip: You will need to convert the medication variables to integers: 0 for not used, 1
