...
In R stats methods, the 1st level of a factor is often used as the reference level by default.
So we should keep this in mind, and typically set control levels as the 1st factor level. We can always temporarily change this for plots.
