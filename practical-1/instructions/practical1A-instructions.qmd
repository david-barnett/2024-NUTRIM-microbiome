...
meta <- read_excel(path = "/Users/david/Documents/teaching/workshops/2024-NUTRIM-microbiome/data/papa2012/papa2012_metadata.xlsx", na = "NA")
```
...
<!-- # give your objects an informative name! -->
...
#| fig-width: 8
#| fig-height: 3
ggplot(meta) + geom_bar(aes(y = diagnosis, fill = active)) + theme_bw()
```
